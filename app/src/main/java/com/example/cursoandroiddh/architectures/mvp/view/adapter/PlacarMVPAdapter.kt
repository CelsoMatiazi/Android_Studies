package com.example.cursoandroiddh.architectures.mvp.view.adapter
...
class PlacarMVPAdapter (private val dados: List<PlacarMVP>): RecyclerView.Adapter<PlacarViewHolder>() {
